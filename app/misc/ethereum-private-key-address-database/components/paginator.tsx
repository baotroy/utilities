        ...
        {currentPage.gt(1) && (
          <>
            ...
            <Link
              ...
              replace
              className="flex items-center justify-center px-1.5 h-8 me-1 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800"
            >
              <svg
                className="h-5 w-5"
                viewBox="0 0 20 20"
        ...
        {BigNumber(currentPage).lt(TOTAL_PAGES) && (
          <>
            <Link
              ...
              className="flex items-center justify-center px-1.5 h-8 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700"
            >
              <svg
                className="h-5 w-5"
                viewBox="0 0 20 20"
